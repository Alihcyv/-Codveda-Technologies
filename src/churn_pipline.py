...
models = [
    ...
    (SVC(class_weight='balanced', kernel='rbf', probability=True, random_state=42), "Support Vector Classifier")
]

for model_obj, name in models:
    evaluate_model(model_obj, X_test, y_test, name)
